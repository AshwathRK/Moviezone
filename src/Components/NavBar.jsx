        ...
        <nav className='grid relative navbarColorGradiant lg:grid-cols-12 lg:grid-rows-1 lg:px-5 md:px-3 h-16' data-bs-theme="dark">
            ...
            <div className='col-span-7 col-start-3 flex items-center'>
                <div className='searchBar w-full bg-white h-2/3 rounded-sm grid grid-cols-12 grid-rows-1 '>
                    ...
                    <button onClick={getValuefromInput} className='btnSearch flex flex-none justify-around col-span-2 col-start-11 text-white items-center poppins-semibold'>
                        {
                            loading ?
                                <div className="none spinner-border text-light" role="status">
                                    <span className="visually-hidden">Loading...</span>
                                </div> :
                                <span className='flex justify-center items-center'><img src="search_icon.png" className='h-4 mx-2 searchicon' />Search</span>
