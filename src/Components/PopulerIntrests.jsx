        ...
        <div className='populerInstrests'>
            ...
            <div className='popcards grid gap-3 justify-center'>
                <div className='populercards rounded-xl'>
                    <img src="./public/Category/superHeros.jpeg" className='w-full h-65 object-cover rounded-t-xl' />
                ...
                <div className='populercards rounded-xl'>
                    <img src="./public/Category/Fantasy.jpg" className='w-full h-65 object-cover rounded-t-xl' />
                    <div className='w-full h-18 flex justify-center items-center'>
                ...
                <div className='populercards rounded-xl'>
                    <img src="./public/Category/DarkComedy.jpg" className='w-full h-65 object-cover rounded-t-xl' />
                    <div className='w-full h-18 flex justify-center items-center'>
                ...
                <div className='populercards rounded-xl'>
                    <img src="./public/Category/Thriller.webp" className='w-full h-65 object-cover rounded-t-xl' />
                    <div className='w-full h-18 flex justify-center items-center'>
                ...
                <div className='populercards rounded-xl'>
                    <img src="./public/Category/commedy.webp" className='w-full h-65 object-cover rounded-t-xl' />
                    <div className='w-full h-18 flex justify-center items-center'>
                ...
                <div className='populercards rounded-xl'>
                    <img src="./public/Category/Anime.jpeg" className='w-full h-65 object-cover rounded-t-xl' />
                    <div className='w-full h-18 flex justify-center items-center'>
                ...
                <div className='populercards rounded-xl'>
                    <img src="./public/Category/Biography.jpg" className='w-full h-65 object-cover rounded-t-xl' />
                    <div className='w-full h-18 flex justify-center items-center'>
                ...
                <div className='populercards rounded-xl'>
                    <img src="./public/Category/Action.webp" className='w-full h-65 object-cover rounded-t-xl' />
                    <div className='w-full h-18 flex justify-center items-center'>
                ...
                <div className='populercards rounded-xl'>
                    <img src="./public/Category/Adventure.jpg" className='w-full h-65 object-cover rounded-t-xl' />
                    <div className='w-full h-18 flex justify-center items-center'>
                ...
                <div className='populercards rounded-xl'>
                    <img src="./public/Category/Romance.jpg" className='w-full h-65 object-cover rounded-t-xl' />
                    <div className='w-full h-18 flex justify-center items-center'>
